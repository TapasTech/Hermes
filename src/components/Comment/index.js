    ...
    return (
      <div className={styles.optionArea}>
        <div className={styles.options}>
          ...
          <div className="count">{content.upVotesCount} 赞</div>
        </div>
        {
    ...
    return (
      <div className={styles.detail}>
        <div className="avatar">
          <Avatar url={content.user.displayName || ''} />
        </div>
        <div className={styles.main}>
          <div className={styles.title}>
            <div className="from">{content.author.name}</div>
            { content.replyTo && <div className="to"><span className="tip">回复</span>{content.replyTo.displayName}</div>}
          </div>
